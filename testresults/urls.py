...
#    url(r'^commits/(?P<commit_id>[0-9]+)$', 'testresults.views.commit_detail'),
    url(r'^executions$', 'testresults.views.testexecutions_list'),
    url(r'^executions/compare/(?P<execution1_id>[0-9]+)/(?P<execution2_id>[0-9]+)$', 'testresults.views.testexecutions_compare'),
    url(r'^executions/(?P<execution_id>[0-9]+)$', 'testresults.views.testexecution_detail'),
    url(r'^results/(?P<testresult_id>[0-9]+)$', 'testresults.views.testresult_detail'),
